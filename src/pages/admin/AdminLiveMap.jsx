    ...
    <AdminLayout>
      <div className="p-3 sm:p-4 lg:p-6 space-y-3 max-w-[1800px] mx-auto h-[calc(100vh-56px)] sm:h-[calc(100vh-80px)] flex flex-col">
        ...
        <div className="flex-1 flex flex-col lg:flex-row gap-3 min-h-0 overflow-hidden relative">
          ...
          {/* Map Panel */}
          <div className="flex-1 relative overflow-hidden rounded-2xl border border-[var(--border-color)] shadow-2xl" style={{ minHeight: "400px" }}>
            <MapContainer center={flyCenter || defaultCenter} zoom={flyZoom || 5} style={{ height: "100%", width: "100%" }} zoomControl={false}>
